...
def play():
    ...
    def grid(turn) :
        ...
        pygame.draw.rect(screen,black,(0,0,350,50))
        pygame.draw.rect(screen,blue,(0,100,350,300))

        
        if turn == 2 :
            pygame.draw.circle(screen,yellow,(25,25),23)
            text = font.render("AI turn", True, white)
        else :
            pygame.draw.circle(screen,red,(25,25),23)      
            text = font.render("Your turn", True, white)
        screen.blit(text,(50,10))

        for i in range(6):
            for j in range(7):
                pygame.draw.circle(screen,white,(((j)*50)+25,(i*50)+125),22)
        pcir()
        pygame.display.flip() 
    #--------------------------------------------------------------------------------------------
    def aniM(posi,turn) : 
        ...
        if turn == 2 :
            pygame.draw.circle(screen,yellow,((posi*50)+25,75),23)
        else :       
            pygame.draw.circle(screen,red,((posi*50)+25,75),23)
        grid(turn)
    #--------------------------------------------------------------------------------------------
    def aniD(posi,turn) :
        screen.fill(white)   
        ...
        for i in range(6-y[posi]):
            ...
            grid(turn)
            if turn == 2 :
                pygame.draw.circle(screen,yellow,((posi*50)+25,(i*50)+125),23)
                #print("y {}".format((i*50)+125))
            else :       
                pygame.draw.circle(screen,red,((posi*50)+25,(i*50)+125),23)
                #print("y {}".format((i*50)+125))
            pygame.display.flip()
    ...
    def pcir():
        for xp in range(7):
            for yp in range(6):
                if a[yp][xp] == 1:
                    pygame.draw.circle(screen,red,((xp*50)+25,((yp)*50)+125),23)
                elif a[yp][xp] == 2:
                    pygame.draw.circle(screen,yellow,((xp*50)+25,((yp)*50)+125),23)   
    #--------------------------------------------------------------------------------------------
...
#         # if AI == won:
#         BACK_TEXT = get_font(90).render("You won!!!", True, "#b68f40")
#         # if player == won:
#         BACK_TEXT = get_font(90).render("AI won!!!", True, "#b68f40")
#         BACK_RECT = BACK_TEXT.get_rect(center=(175, 150))
#         BACK_BUTTON = Button(image=None, pos=(175, 350), 
#                             text_input="Back to Main menu", font= get_font(50), base_color="#E6AE17", hovering_color="White")
...
def main_menu():
    ...
    while True:
        ...
        MENU_RECT = MENU_TEXT.get_rect(center=(175, 40))

        PLAY_BUTTON = Button(image=None, pos=(175, 150), 
                            text_input="PLAY", font= get_font(60), base_color="#E6AE17", hovering_color="White")
        QUIT_BUTTON = Button(image=None, pos=(175, 250), 
                            text_input="QUIT", font= get_font(60), base_color="#E6AE17", hovering_color="White")
